...
<html lang="en">
  <head>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Register Scrowz</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Sign In</h3>
						<form action="<?php echo site_url('auth/do_register') ?>" class="login-form" method="POST">
	...
	<script src="<?php echo base_url('assets/auth/js/jquery.min.js') ?>"></script>
  <script src="<?php echo base_url('assets/auth/js/popper.js') ?>"></script>
